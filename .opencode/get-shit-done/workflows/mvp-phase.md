...
<required_reading>
@C:/Users/user/presenca-ativa-inteligente/.opencode/get-shit-done/references/user-story-template.md
@C:/Users/user/presenca-ativa-inteligente/.opencode/get-shit-done/references/spidr-splitting.md
@C:/Users/user/presenca-ativa-inteligente/.opencode/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@C:/Users/user/presenca-ativa-inteligente/.opencode/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `question` calls. Each is free-text. After all three, assemble into the canonical sentence per `@C:/Users/user/presenca-ativa-inteligente/.opencode/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@C:/Users/user/presenca-ativa-inteligente/.opencode/get-shit-done/references/spidr-splitting.md`. Briefly:
