...
```bash
INIT=$(node "C:/Users/user/presenca-ativa-inteligente/.opencode/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/Users/user/presenca-ativa-inteligente/.opencode/get-shit-done/bin/gsd-tools.cjs" commit \
