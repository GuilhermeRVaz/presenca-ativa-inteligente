...
INSTALL_JS_GLOBAL="C:/Users/user/presenca-ativa-inteligente/.opencode/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/Users/user/presenca-ativa-inteligente/.opencode/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
