...
```
Agent(
  prompt="Read C:/Users/user/presenca-ativa-inteligente/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/user/presenca-ativa-inteligente/.opencode/get-shit-done/templates/SECURITY.md`
