-- Busca Ativa Escolar V2 - conversation_sessions permissions and upsert constraint
...
comment on table busca_ativa_v2.conversation_sessions is
  'Armazena janelas de contexto conversacional para mapear contatos (incluindo @lid) para guardioes e alunos de forma persistente.';

comment on column busca_ativa_v2.conversation_sessions.resolved is
  'Verdadeiro se a sessao ja foi vinculada a um responsavel/aluno com confianca.';

comment on column busca_ativa_v2.conversation_sessions.resolution_source is
  'Origem da resolucao da identidade (ex: outbound_context, manual, push_name, phone_map).';
