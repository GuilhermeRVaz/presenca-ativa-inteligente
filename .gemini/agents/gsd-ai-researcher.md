...
<required_reading>
Read `C:/Users/user/presenca-ativa-inteligente/.gemini/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
