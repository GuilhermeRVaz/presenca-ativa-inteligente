...
- Usage: Reference from command with `@C:/Users/user/presenca-ativa-inteligente/.gemini/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to C:/Users/user/presenca-ativa-inteligente/.gemini/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to C:/Users/user/presenca-ativa-inteligente/.gemini/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
