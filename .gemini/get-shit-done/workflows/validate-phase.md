...
```
Agent(
  prompt="Read C:/Users/user/presenca-ativa-inteligente/.gemini/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/user/presenca-ativa-inteligente/.gemini/get-shit-done/templates/VALIDATION.md`
