...
```bash
INIT=$(node "C:/Users/user/presenca-ativa-inteligente/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/Users/user/presenca-ativa-inteligente/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
