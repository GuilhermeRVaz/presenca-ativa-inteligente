...
```markdown
Read C:/Users/user/presenca-ativa-inteligente/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/Users/user/presenca-ativa-inteligente/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/Users/user/presenca-ativa-inteligente/.claude/agents/gsd-ui-checker.md for instructions.
