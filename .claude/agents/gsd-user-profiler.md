...
<reference>
@C:/Users/user/presenca-ativa-inteligente/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `C:/Users/user/presenca-ativa-inteligente/.claude/get-shit-done/references/user-profiling.md` to load:
